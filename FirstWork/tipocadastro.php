        ...
        <div class="container-fluid tm-mt-60">
            ...
            <div class="col-lg-22 col-14 mb-5">
                ...
                <form id="usuarioForm" data-sb-form-api-token="API_TOKEN" method="POST" action="php/usuario.cadastro.php" class="tm-contact-form mx-auto">
                    <button class="btn btn-warning text-uppercase form-control rounded-0" id="submitButton"><a href="cadastro.php">Cadastro de usuário</a></button><br><br>
                    <button class="btn btn-warning text-uppercase form-control rounded-0" id="submitButton"><a href="cadastroempresa.php">Cadastro de empresa</button>         
                </form>                
            </div>
        </div>
    </section>
